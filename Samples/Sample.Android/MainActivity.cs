...
{
	[Activity(Label = "Ateri. Сканер штрих-кодов.", MainLauncher = true, Theme = "@style/Theme.AppCompat.Light", ConfigurationChanges = ConfigChanges.Orientation | ConfigChanges.KeyboardHidden)]
